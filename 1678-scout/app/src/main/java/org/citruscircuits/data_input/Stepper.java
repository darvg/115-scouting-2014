...
import org.citruscircuits.scout.TeleDataCollectionItems;
...
public class Stepper extends DataInputView implements OnTouchListener
{
	...
	{
		this(context, "my_key", new String[] { "Default" }, false);
	}
	
	public Stepper(Context context, String dataKey, String[] args, boolean isAuto)
	{
...
//			TeleMatchActivity.updateHashMap();
			SavedData.setTeleData(dataKey, value);
		}
		
		else{
//			AutoMatchActivity.updateHashMap();
			SavedData.setAutoData(dataKey, value);
