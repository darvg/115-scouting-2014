...
public abstract class DataInputView extends LinearLayout
{
	...
	public DataInputView(Context context, String dataKey, String[] args, boolean isAuto)
	{
		super(context);
	...
	public static void fillLayoutWithItems(Context context, LinearLayout layout, String[][] items, boolean auto)
	{
		for (String[] item : items)
		{
			...
			try
			{
				...
				{
					DataInputView inputView = (DataInputView) itemClass.getConstructor(Context.class, String.class, String[].class, boolean.class).newInstance(context, key, args, auto);
					inputView.setPadding(0, 20, 0, 0);
